...
exports.default = (0, _utils.create)({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "van-address-edit" }, [_c('cell-group', [_c('field', { attrs: { "maxlength": "15", "placeholder": _vm.$t('placeholder.name'), "label": _vm.$t('label.name', _vm.computedAddressText), "error": _vm.errorInfo.name }, on: { "focus": function focus($event) {
        ...
        } } }, [_c('span', [_vm._v(_vm._s(_vm.currentInfo.province || _vm.$t('placeholder.province')))]), _c('span', [_vm._v(_vm._s(_vm.currentInfo.city || _vm.$t('placeholder.city')))]), _c('span', [_vm._v(_vm._s(_vm.currentInfo.county || _vm.$t('placeholder.county')))])]), _c('address-edit-detail', { attrs: { "value": _vm.currentInfo.address_detail, "isError": _vm.errorInfo.address_detail, "showSearchResult": _vm.showSearchResult, "searchResult": _vm.searchResult }, on: { "focus": function focus($event) {
          _vm.onFocus('address_detail');
        }, "blur": _vm.onDetailBlur, "input": _vm.onChangeDetail } }), _vm.showPostal ? _c('field', { directives: [{ name: "show", rawName: "v-show", value: !_vm.hideBottomFields, expression: "!hideBottomFields" }], staticClass: "van-hairline--top", attrs: { "type": "tel", "label": _vm.$t('label.postal'), "placeholder": _vm.$t('placeholder.postal'), "maxlength": "6", "error": _vm.errorInfo.postal_code }, on: { "focus": function focus($event) {
        ...
        }, expression: "currentInfo.postal_code" } }) : _vm._e(), _vm.showSetDefault ? _c('switch-cell', { directives: [{ name: "show", rawName: "v-show", value: !_vm.hideBottomFields, expression: "!hideBottomFields" }], attrs: { "title": _vm.$t('defaultAddress', _vm.computedAddressText) }, model: { value: _vm.currentInfo.is_default, callback: function callback($$v) {
          _vm.$set(_vm.currentInfo, "is_default", $$v);
        }, expression: "currentInfo.is_default" } }) : _vm._e()], 1), _c('div', { directives: [{ name: "show", rawName: "v-show", value: !_vm.hideBottomFields, expression: "!hideBottomFields" }], staticClass: "van-address-edit__buttons" }, [_c('van-button', { attrs: { "block": "", "loading": _vm.isSaving, "type": "primary" }, on: { "click": _vm.onSaveAddress } }, [_vm._v("\n      " + _vm._s(_vm.$t('save')) + "\n    ")]), _vm.isEdit ? _c('van-button', { attrs: { "block": "", "loading": _vm.isDeleting }, on: { "click": _vm.onDeleteAddress } }, [_vm._v("\n      " + _vm._s(_vm.$t('deleteAddress', _vm.computedAddressText)) + "\n    ")]) : _vm._e()], 1), _c('popup', { attrs: { "position": "bottom" }, model: { value: _vm.showAreaSelect, callback: function callback($$v) {
