...
exports.default = (0, _utils.create)({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "van-picker-column", class: _vm.className }, [_c('div', { staticClass: "van-picker-column__frame van-hairline--top-bottom", style: _vm.frameStyle }), _c('ul', { style: _vm.wrapperStyle, on: { "touchstart": _vm.onTouchStart, "touchmove": function touchmove($event) {
          $event.preventDefault();_vm.onTouchMove($event);
        }, "touchend": _vm.onTouchEnd, "touchcancel": _vm.onTouchEnd } }, _vm._l(_vm.options, function (option, index) {
      return _c('li', { class: {
